...
public class SharkGestureTypingDetectorTest {
    private static final int MAX_SUGGESTIONS = 4;
    private static final int PRUNING_DISTANCE = 7;
    private List<Keyboard.Key> mKeys;
    private SharkGestureTypingDetector mDetectorUnderTest;
    private AtomicReference<SharkGestureTypingDetector.LoadingState> mCurrentState;
    ...
    public void setUp() {
        ...
        mDetectorUnderTest = new SharkGestureTypingDetector(
            MAX_SUGGESTIONS,
        ...
        Assert.assertEquals(
                SharkGestureTypingDetector.LoadingState.NOT_LOADED,
                mCurrentState.get()
        );
        ...
        Assert.assertEquals(SharkGestureTypingDetector.LoadingState.LOADED, mCurrentState.get());
    }
    ...
    public void testGestureGetLength() {
        ...
        double length = SharkGestureTypingDetector.euclideanDistance(
                key1.centerX,
                key1.centerY,
                key2.centerX,
                key2.centerY
    ...
    public void testEuclideanDistance() {
        ...
        double distance1 = SharkGestureTypingDetector.euclideanDistance(0, 0, 1, 1);
        double distance2 = SharkGestureTypingDetector.euclideanDistance(1, 0, 2, 1);
