...
public class GestureTypingDetectorTest {
    ...
    public void setUp() {
        ...
        Assert.assertEquals(
                SharkGestureTypingDetector.LoadingState.NOT_LOADED, mCurrentState.get());
        ...
        Assert.assertEquals(SharkGestureTypingDetector.LoadingState.LOADING, mCurrentState.get());
    }
    ...
    public void testGestureGetLength() {
        ...
        double length =
                SharkGestureTypingDetector.euclideanDistance(
