...
/**
 * Implements a simplified version of the Shark gesture detection algorithm as described in:
 * Kristensson, Per-Ola & Zhai, Shumin. (2004). SHARK2:A large Vocabulary shorthand writing system
 * for pen-based computers. Proceedings of the 17th Annual ACM Symposium on User Interface Software
 * and Technology. 10.1145/1029632.1029640.
 */
public class SharkGestureTypingDetector extends GestureTypingDetector {
    ...
    public SharkGestureTypingDetector(
            int maxSuggestions,
